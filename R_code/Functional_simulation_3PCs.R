...
save(tr_gen3_20,file = "tr_gen4_20.Rdata")
save(tr_env3_20,file = "tr_env4_20.Rdata")
save(gen_err3_20,file = "gen_err4_20.Rdata")
save(env_err3_20,file = "env_err4_20.Rdata")