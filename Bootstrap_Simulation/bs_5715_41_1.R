...
CG_fun_sap41_1 <- array(data = 0, c(n,n,n_iter)) # 3d matrix store genetic covariance function of 50 iterations
CE_fun_sap41_1 <- array(data = 0, c(n,n,n_iter)) # 3d matrix store environmental covariance function of 50 iterations
...
for (k in 1:n_iter){
  ...
  Y_est41_1[,k] <- Yk@x
  save(Y_est41_1, file = "bs_sample_51050_41_1.Rdata")
