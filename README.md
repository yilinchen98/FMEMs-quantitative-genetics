...
## Contents
The pdf file `FMEMs in Quantitative Genetics` contains a detailed version of this research project outline, with the mathematical formulation of the functional mixed-effect model,  model representations and fitting procedures. 
## R codes
